                ...
                <View style={styles.featuresContainer}>
                    ...
                    <View style={styles.cardGrid}>
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                router.push("/(record)/symptominput")
                            }
                        >
                            <LinearGradient
                                colors={["#D92B4B", "#FF6B8A"]}
                        ...
                        <TouchableOpacity
                            style={styles.featureCard}
                            onPress={() =>
                                router.push("/(dictionary)/medication")
                            }
                        >
                            <LinearGradient
...
bmiCard: {
    ...
    padding: 16,
    borderWidth: 1,
    borderColor: '#D92B4B20', // 🔴 테두리 색상 유지
    backgroundColor: '#FFFFFF', // ✅ 배경은 흰색
    marginBottom: 10,
},
